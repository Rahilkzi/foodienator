<div class="container shadow-container">
    ...
    <form action="<?php echo base_url().'admin/category/create_category';?>" class="container my-3" method="POST" id="myForm"  enctype="multipart/form-data">
        ...
        <div class="form-group">
                    ...
                    <input type="file" name="image" class="<?php echo(!empty($errorImageUpload))  ? 'is-invalid' : '';?>">
